	...
	$.extend({
		...
		tablesorter: new function() {
			...
			ts.defaults = {
				...
				cssIconNone      : 'fa fw fa-sort', // class name added to the icon when there is no column sort
				cssIconAsc       : 'fa fw fa-sort-asc', // class name added to the icon when the column has an ascending sort
				cssIconDesc      : 'fa fw fa-sort-desc', // class name added to the icon when the column has a descending sort
